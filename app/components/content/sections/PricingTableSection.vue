  ...
  >
    ...
    <div class="flex flex-col items-center gap-6 mb-[80px] md:mb-[120px]">
      ...
      <h2 class="text-center">
        <span
          class="block text-[32px] md:text-[56px] font-normal text-[#1e1e1e] leading-[1.15]"
          >Get started for free</span
        >
        <span
          class="block text-[32px] md:text-[56px] font-normal text-[rgba(64,64,64,0.28)] leading-[1.15]"
    ...
    <div class="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-5">
      <!-- Pricing Card -->
      <div
      ...
      >
        ...
        <!-- Title & Price -->
        <div class="mb-6">
          <h3 class="text-[20px] font-semibold text-[#1e1e1e] mb-2">
            {{ plan.title }}
          </h3>
        ...
        <div class="flex items-center gap-4 mb-8">
          <a
            ...
            :class="[
              ...
              plan.id === 'custom-solutions' ? 'bg-[#1e1e1e]' : 'bg-[#fb411f]',
            ]"
          >
            {{ plan.primaryCta }}
          </a>
